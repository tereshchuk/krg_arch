...
class StackingScreen2 extends StatefulWidget {
  @override
  _StackingScreenState2 createState() => _StackingScreenState2();
}

class _StackingScreenState2 extends State<StackingScreen2> {
  final Widget svg =
